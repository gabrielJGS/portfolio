...
import {
  projetoRecordar,
  projetoEsclarecaImgs,
  projetoImgTranslator,
  projetoNlw2023,
  noImage,
} from "../utils/projetosFotos";
  ...
  return (
    <section id="projetos">
      ...
      <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
        <div className="basis-1/4 p-4 flex flex-1 flex-col items-center rounded-lg bg-white dark:bg-slate-800">
          <ImageGallery items={projetoNlw2023} showFullscreenButton />
          <div>
            <h5 className="text-xl font-bold text-center pb-2 dark:text-yellow-600 mt-auto">Next Level Week 2023</h5>
            <p className="text-md text-center py-1 px-4 leading-8 text-gray-700 dark:text-gray-400 relative">
        ...
        <div className="basis-1/4 p-4 flex flex-1 flex-col items-center rounded-lg bg-white dark:bg-slate-800">
          <ImageGallery items={noImage} showFullscreenButton />
          <div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-10 justify-center">
              <AiFillTwitterCircle
                ...
                width={20}
                height={20}
                className="text-[40px] mx-auto text-blue-600"
              />
              <SiPython title="Python" width={20} height={20} className="text-[40px] mx-auto text-yellow-500" />
              <SiGoogletranslate
